# LLM Discount Advisor — отчёт от 2026-09-04

Decision-support для выбора модели и provider/variant в Hermes.

Legacy snapshot: **427** строк каталога / **346** семейств; после scope gate прошло **114** строк / **71** семейств.
...
Candidates: 18; raw Pareto: 7; stable Pareto: 11.
- balanced default: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 65.7
- cost option: `z-ai/glm-5.3-flash-20260826` / Novita / $0.1474095763 / score 57.5
- quality option: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 65.7

### Профиль `code`

Quality: `coding`; floor: —.
Candidates: 33; raw Pareto: 5; stable Pareto: 14.
- balanced default: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 81.6
- cost option: `z-ai/glm-5.3-flash-20260826` / Novita / $0.1474095763 / score 71.5
- quality option: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 81.6

### Профиль `agentic`

Quality: `agentic`; floor: —.
Candidates: 24; raw Pareto: 4; stable Pareto: 6.
- balanced default: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 61.3
- cost option: `z-ai/glm-5.3-flash-20260826` / Novita / $0.1474095763 / score 58.2
- quality option: `anthropic/claude-fable-5.1-20260831` / Azure / $29.9802717342 / score 61.3
...
Quality: `intelligence`; floor: —.
Candidates: 18; raw Pareto: 6; stable Pareto: 10.
- balanced default: `anthropic/claude-opus-5-20260723` / Azure / $11.1414669785 / score 63.1
- cost option: `openai/gpt-5.6-luna-20260709` / OpenAI / $0.1903094052 / score 52.3
- quality option: `anthropic/claude-opus-5-20260723` / Azure / $11.1414669785 / score 63.1

### Secondary evidence coverage

Families total: 346; uncovered: 184;
...
- **Это твой рабочий вариант** — `Z.ai: GLM 5.3 Flash` через Novita: $0.1187/1M, intelligence 57.5, скидка 67%. Почему: intelligence 57.5 при цене $0.119/1M; от лидера по качеству отстаёт на 8.2 п. Reasoning: `max`, обязателен.
- **Та же модель, но дешевле провайдер** — `Google: Gemini 3.8 Flash` через Google AI Studio: $0.7500/1M, intelligence 58.7, скидка 50%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.09%. Reasoning: `medium`, обязателен.
...
- **Скорее всего, менять не стоит** — `Z.ai: GLM 5.3` через Decart: $1.8060/1M, intelligence 59.5, скидка 16%. Почему: Преимущество не окупает смену: цена $1.806/1M без минимум 30% экономии относительно дефолта. Reasoning: `max`, обязателен.
...
- **Та же модель, но дешевле провайдер** — `Google: Gemini 3.8 Flash` через Google AI Studio: $0.7500/1M, coding 76.3, скидка 50%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.09%. Reasoning: `medium`, обязателен.
...
- **Скорее всего, менять не стоит** — `Z.ai: GLM 5.3 Flash` через Novita: $0.1187/1M, coding 71.5, скидка 67%. Почему: Преимущество не окупает смену: цена $0.119/1M без минимум 30% экономии относительно дефолта. Reasoning: `max`, обязателен.
...
- **Та же модель, но дешевле провайдер** — `Google: Gemini 3.8 Flash` через Google AI Studio: $0.7500/1M, agentic 50.0, скидка 50%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.09%. Reasoning: `medium`, обязателен.
...
- **Скорее всего, менять не стоит** — `Z.ai: GLM 5.3 Flash` через Novita: $0.1187/1M, agentic 58.2, скидка 67%. Почему: Преимущество не окупает смену: цена $0.119/1M без минимум 30% экономии относительно дефолта. Reasoning: `max`, обязателен.

### Длинные документы (`longdoc`)

- **Это твой рабочий вариант** — `Z.ai: GLM 5.3 Flash` через Novita: $0.0909/1M, intelligence 57.5, скидка 67%. Почему: intelligence 57.5 при цене $0.091/1M; от лидера по качеству отстаёт на 8.2 п. Reasoning: `max`, обязателен.
- **Та же модель, но дешевле провайдер** — `Google: Gemini 3.8 Flash` через Google AI Studio: $0.5114/1M, intelligence 58.7, скидка 50%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.09%. Reasoning: `medium`, обязателен.
...
- **Та же модель, но дешевле провайдер** — `OpenAI: GPT-5.6 Luna` через OpenAI: $0.4750/1M, intelligence 52.3. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.93%. Reasoning: `medium`, можно отключить/не указан.
