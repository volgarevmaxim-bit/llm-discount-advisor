# LLM Discount Advisor — отчёт от 2026-09-14
...
- balanced default: `anthropic/claude-fable-5.1-20260831` / Azure / $34.7268521907 / score 81.6
- cost option: `deepseek/deepseek-v4-flash-20260731` / Baidu / $0.1022697769 / score 69.1
- quality option: `anthropic/claude-fable-5.1-20260831` / Azure / $34.7268521907 / score 81.6

### Профиль `agentic`

Quality: `agentic`; floor: —.
Candidates: 12; raw Pareto: 4; stable Pareto: 6.
- balanced default: `anthropic/claude-opus-5-20260723` / Azure / $16.7567668305 / score 56.2
- cost option: `z-ai/glm-5.3-flash-20260826` / DeepInfra / $0.2811205975 / score 51.2
- quality option: `anthropic/claude-fable-5.1-20260831` / Azure / $34.7268521907 / score 58.0
...
- balanced default: `anthropic/claude-opus-5-20260723` / Azure / $16.7567668305 / score 50.7
- cost option: `openai/gpt-5.6-sol-20260709` / OpenAI / $5.0314169272 / score 47.1
- quality option: `anthropic/claude-opus-5-20260723` / Azure / $16.7567668305 / score 50.7
...
- **Это твой рабочий вариант** — `DeepSeek: DeepSeek V4 Flash 0731` через Baidu: $0.0528/1M, coding 69.1, скидка 92%. Почему: coding 69.1 при цене $0.053/1M; от лидера по качеству отстаёт на 12.5 п. Reasoning: `high`, можно отключить/не указан.
