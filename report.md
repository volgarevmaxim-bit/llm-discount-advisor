# LLM Discount Advisor — отчёт от 2026-08-21

Decision-support для выбора модели и provider/variant в Hermes.

Legacy snapshot: **419** строк каталога / **348** семейств; после scope gate прошло **109** строк / **77** семейств.
...
- balanced default: `anthropic/claude-opus-5-20260723` / Claude Platform on AWS / $11.5850224725 / score 63.1
- cost option: `google/gemini-3.7-flash-20260813` / Google / $0.6619589717 / score 56.0
- quality option: `anthropic/claude-opus-5-20260723` / Claude Platform on AWS / $11.5850224725 / score 63.1

### Профиль `code`

Quality: `coding`; floor: —.
Candidates: 31; raw Pareto: 6; stable Pareto: 10.
- balanced default: `openai/gpt-5.6-terra-20260709` / OpenAI / $2.7464705398 / score 76.7
- cost option: `deepseek/deepseek-v4-flash-20260731` / Relace / $0.1652378993 / score 69.1
- quality option: `openai/gpt-5.6-sol-20260709` / OpenAI / $5.4432752058 / score 78.3

### Профиль `agentic`

Quality: `agentic`; floor: —.
Candidates: 21; raw Pareto: 5; stable Pareto: 10.
- balanced default: `z-ai/glm-5.3-20260816` / Z.AI / $2.9233673758 / score 59.1
- cost option: `deepseek/deepseek-v4-flash-20260731` / Relace / $0.1652378993 / score 48.4
- quality option: `anthropic/claude-opus-5-20260723` / Claude Platform on AWS / $11.5850224725 / score 59.2
...
Quality: `intelligence`; floor: —.
Candidates: 19; raw Pareto: 8; stable Pareto: 11.
- balanced default: `anthropic/claude-opus-5-20260723` / Claude Platform on AWS / $11.5850224725 / score 63.1
- cost option: `deepseek/deepseek-v4-flash-20260731` / Relace / $0.1652378993 / score 51.8
- quality option: `anthropic/claude-opus-5-20260723` / Claude Platform on AWS / $11.5850224725 / score 63.1
...
- **Та же модель, но дешевле провайдер** — `OpenAI: GPT-5.6 Terra` через OpenAI: $2.2500/1M, intelligence 56.6. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.90%. Reasoning: `medium`, можно отключить/не указан.
...
- **Та же модель, но дешевле провайдер** — `DeepSeek: DeepSeek V4 Flash 0731` через Relace: $0.0875/1M, coding 69.1, скидка 44%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.60%. Reasoning: `high`, можно отключить/не указан.
...
- **Та же модель, но дешевле провайдер** — `DeepSeek: DeepSeek V4 Flash 0731` через Relace: $0.0875/1M, agentic 48.4, скидка 44%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.60%. Reasoning: `high`, можно отключить/не указан.
...
- **Та же модель, но дешевле провайдер** — `OpenAI: GPT-5.6 Terra` через OpenAI: $1.4545/1M, intelligence 56.6. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.90%. Reasoning: `medium`, можно отключить/не указан.
...
- **Та же модель, но дешевле провайдер** — `DeepSeek: DeepSeek V4 Flash 0731` через Relace: $0.1225/1M, intelligence 51.8, скидка 44%. Почему: У этой же модели есть провайдер дешевле в 2.0 раза при uptime 99.60%. Reasoning: `high`, можно отключить/не указан.
